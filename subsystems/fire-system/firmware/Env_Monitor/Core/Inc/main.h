...
#define FIRE_1_Pin GPIO_PIN_3
#define FIRE_1_GPIO_Port GPIOA
#define FIRE_2_Pin GPIO_PIN_4
#define FIRE_2_GPIO_Port GPIOA
#define SPRINKLER_1_Pin GPIO_PIN_5
#define SPRINKLER_1_GPIO_Port GPIOA
#define SPRINKLER_2_Pin GPIO_PIN_6
#define SPRINKLER_2_GPIO_Port GPIOA
